...
#' associations with each lipid fraction, the associations between genetic variants and systolic blood pressure,
#' and corresponding standard errors.
#' 
#' rawdat_mvmr
#'
#' @format A data frame with 145 rows and 9 variables. A full description of the data is available
#' by using the command \code{vignette("MVMR")}.
#' 
#' @source 
#' \itemize{
