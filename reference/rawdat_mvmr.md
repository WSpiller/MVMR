...
variants and systolic blood pressure, and corresponding standard errors.
...
A data frame with 145 rows and 9 variables. A full description of the
data is available by using the command
