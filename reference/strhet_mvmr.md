...
in two sample summary multivariable Mendelian randomization through
minimisation of Q-statistics. The function takes a formatted dataframe
as an input, obtained using the function
